										...
										<div class="sign-in-form">
											<div class="in-form Personal">
												...
												<form method="post" action="signup">
													...
													<input type="text" name="name" class="textbox" value="Enter your name here..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter your name here...';}">
													
													<input type="text" name="email" class="textbox" id="email" value="Enter your email here..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email';}">
												    <h5>Login Information password</h5>
												    <input type="text" name="password" class="password" value="Enter your password..." onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Password';}">
...
<!-- //banner -->
<div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >ÃÂ¦ÃÂÃÂÃÂ¦ÃÂÃÂºÃÂ§ÃÂ½ÃÂÃÂ§ÃÂ«ÃÂÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂ¿</a></div>
<!-- welcome -->
	<div class="welcome">
		<div class="container">
			<h3>Welcome !</h3>
...
<!--footer-->
	...
	<div class="footer-bottom">
		<div class="container">		
			<p>Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂ¿ÃÂ¤ÃÂ¹ÃÂÃÂ¥ÃÂ®ÃÂ¶">ÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂ¿ÃÂ¤ÃÂ¹ÃÂÃÂ¥ÃÂ®ÃÂ¶</a> - Collect from <a href="http://www.cssmoban.com/" title="ÃÂ§ÃÂ½ÃÂÃÂ©ÃÂ¡ÃÂµÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂ¿" target="_blank">ÃÂ§ÃÂ½ÃÂÃÂ©ÃÂ¡ÃÂµÃÂ¦ÃÂ¨ÃÂ¡ÃÂ¦ÃÂÃÂ¿</a></p>					
		</div>
	</div>
<!--//footer-->	
